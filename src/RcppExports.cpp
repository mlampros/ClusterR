...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(KMEANS_rcpp(data, clusters, num_init, max_iters, initializer, fuzzy, threads, verbose, CENTROIDS, tol, eps, tol_optimal_init, seed));
    return rcpp_result_gen;
END_RCPP
}
// KMEANS_arma
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type eps(epsSEXP);
    Rcpp::traits::input_parameter< bool >::type fuzzy(fuzzySEXP);
    rcpp_result_gen = Rcpp::wrap(fuzzy_and_stats(data, threads, eps, fuzzy));
    return rcpp_result_gen;
END_RCPP
}
// isolation
